        ...
        <div className="lg:flex lg:justify-between lg:gap-10 pointer-events-auto">
          ...
          <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[45%] lg:flex-col lg:justify-between lg:py-24">
            ...
            <ul className="ml-1 mt-12 flex items-center gap-6">
              ...
              <li className="text-xs">
                <a className="block text-slate-400 hover:text-white transition-all hover:scale-110 drop-shadow-md" href="https://linkedin.com/in/meetpatel" target="_blank" rel="noreferrer">
                  <span className="sr-only">LinkedIn</span><Linkedin size={26} />
                </a>
              </li>
              <li className="text-xs">
                <a className="block text-slate-400 hover:text-white transition-all hover:scale-110 drop-shadow-md" href="mailto:m.patel6@student.fdu.edu">
          ...
          <main className="pt-24 lg:w-[55%] lg:py-24 space-y-32">
              ...
              <div className="space-y-6">
                ...
                <a href="#" target="_blank" rel="noreferrer" className="block liquid-glass p-8 group relative transition-all hover:scale-[1.01]">
                  <div className="z-10">
                    ...
                    <ul className="mt-5 flex flex-wrap gap-2" aria-label="Technologies used">
                       <li><span className="flex items-center rounded-full bg-white/5 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-white border border-white/10">Apple Neural Engine</span></li>
              ...
              <div className="space-y-6">
                ...
                <div className="liquid-glass p-8 group relative flex flex-col md:flex-row gap-6 md:gap-8 transition-all hover:scale-[1.01]">
                  ...
                  <div className="z-10 md:w-3/4">
                    <h3 className="font-bold text-xl text-white flex items-center gap-2 group/link">
                      Research Assistant <span className="text-slate-500 font-normal">·</span> FDU
                    </h3>
                    <p className="mt-3 text-sm leading-relaxed text-slate-300 font-medium glass-text">
                      Led research to resolve complex spatial dependencies in computer vision models using Graph Neural Networks (GNNs) and hybrid Vision Transformers (ViT), resulting in a paper acceptance at the IEEE ISEC'26 conference. Benchmarked SOTA models across 10,000+ patient records, improving inference precision from 81.00% to 97.75%.
                    </p>
                ...
                <div className="liquid-glass p-8 group relative flex flex-col md:flex-row gap-6 md:gap-8 transition-all hover:scale-[1.01]">
                  ...
                  <div className="z-10 md:w-3/4">
                    <h3 className="font-bold text-xl text-white flex items-center gap-2 group/link">
                      Teaching Assistant <span className="text-slate-500 font-normal">·</span> FDU
                    </h3>
                    <p className="mt-3 text-sm leading-relaxed text-slate-300 font-medium glass-text">
                      Evaluated coursework for 100+ students, focusing on the reinforcement of Machine Learning concepts and practical application. Responsible for the detailed assessment of 70+ academic projects, fostering an environment of continuous architectural improvement.
                    </p>
                    <ul className="mt-4 flex flex-wrap gap-2" aria-label="Technologies used">
                ...
                <div className="liquid-glass p-8 group relative flex flex-col md:flex-row gap-6 md:gap-8 transition-all hover:scale-[1.01]">
                  ...
                  <div className="z-10 md:w-3/4">
                    <h3 className="font-bold text-xl text-white flex items-center gap-2 group/link">
                      ML Intern <span className="text-slate-500 font-normal">·</span> Tri State Technologies
                    </h3>
                    <p className="mt-3 text-sm leading-relaxed text-slate-300 font-medium glass-text">
                ...
                <div className="liquid-glass p-8 group relative flex flex-col md:flex-row gap-6 md:gap-8 transition-all hover:scale-[1.01]">
                  ...
                  <div className="z-10 md:w-3/4">
                    <h3 className="font-bold text-xl text-white flex items-center gap-2 group/link">
                      Software Engineer <span className="text-slate-500 font-normal">·</span> Vikartr Technologies
                    </h3>
                    <p className="mt-3 text-sm leading-relaxed text-slate-300 font-medium glass-text">
                      Engineered performant, responsive user interfaces using React.js and Tailwind CSS, optimizing rendering speed. Refactored complex codebases using React Hooks for robust state management and seamless API callback integration.
                    </p>
                    <ul className="mt-4 flex flex-wrap gap-2" aria-label="Technologies used">
            ...
            <section id="contact" className="scroll-mt-24 pb-32">
               <div className="mb-8">
                <h2 className="text-2xl font-bold tracking-tight text-white flex items-center gap-4">
                  <span className="h-px w-8 bg-teal-400/50"></span> Contact Me
                </h2>
              </div>
              
              <div className="liquid-glass p-8 md:p-12 text-center group">
                 <h3 className="text-3xl font-bold text-white mb-4">Let's build the future.</h3>
                 <p className="text-slate-300 font-medium mb-8 max-w-md mx-auto">
                   Currently open to new opportunities at the intersection of complex mathematical theory and high-performance system engineering.
                 </p>
                 <div className="flex flex-col sm:flex-row justify-center gap-4">
                   <a 
                     href="mailto:m.patel6@student.fdu.edu" 
                     className="inline-flex items-center justify-center gap-2 bg-teal-400 text-slate-950 px-6 py-3 rounded-full font-bold text-sm tracking-widest uppercase hover:bg-teal-300 transition-colors"
                   >
                     <Mail size={18} /> Say Hello
                   </a>
                   <a 
                     href="/Meet_Patel_Resume.pdf" 
                     className="inline-flex items-center justify-center gap-2 bg-white/5 text-white border border-white/10 px-6 py-3 rounded-full font-bold text-sm tracking-widest uppercase hover:bg-white/10 transition-colors"
                   >
